...
- [buluma/ansible-role-varnish](https://github.com/buluma/ansible-role-varnish) ([v0.1.2](https://github.com/buluma/ansible-role-varnish/releases/tag/v0.1.2), today) - Installs the Varnish HTTP Cache
