...
- [buluma/ansible-role-influxdb2](https://github.com/buluma/ansible-role-influxdb2) ([0.1.7](https://github.com/buluma/ansible-role-influxdb2/releases/tag/0.1.7), 2 years ago) - Install and configure InfluxDB 2.0 using Ansible.
- [buluma/ansible-role-ansible](https://github.com/buluma/ansible-role-ansible) ([2.5.6](https://github.com/buluma/ansible-role-ansible/releases/tag/2.5.6), 2 years ago) - Install and configure ansible on your system.
...
- [n0mi1k/apk2url](https://github.com/n0mi1k/apk2url) - An OSINT tool to quickly extract IP and URL endpoints from APKs by disassembling and decompiling (1 week ago)
- [kivy/python-for-android](https://github.com/kivy/python-for-android) - Turn your Python application into an Android APK (1 week ago)
- [reworkd/perplexity-style-streaming](https://github.com/reworkd/perplexity-style-streaming) - ⚡️ Perplexity.ai style LLM response streaming (1 week ago)
