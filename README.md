...
- [buluma/ansible-role-ara](https://github.com/buluma/ansible-role-ara) - Install and configure ara on your system. (1 week ago)
- [buluma/ansible-role-bitbucket](https://github.com/buluma/ansible-role-bitbucket) - Ansible Role for Atlassian Bitbucket Installation. (1 week ago)
...
- [Update FEATURES.md with ticket ID badge/link and transparency modal fix](https://github.com/buluma/reddie/pull/26) on [buluma/reddie](https://github.com/buluma/reddie) (3 days ago)
- [Fix lint errors from SHA-40&#39;s issue-detail-helpers.js](https://github.com/buluma/reddie/pull/25) on [buluma/reddie](https://github.com/buluma/reddie) (3 days ago)
- [Extract relation/changelog logic into a testable pure module](https://github.com/buluma/reddie/pull/20) on [buluma/reddie](https://github.com/buluma/reddie) (3 days ago)
- [Add dependabot.yml for npm &#43; GitHub Actions](https://github.com/buluma/reddie/pull/19) on [buluma/reddie](https://github.com/buluma/reddie) (3 days ago)
- [Link ticket ID badge to the issue on Redmine](https://github.com/buluma/reddie/pull/18) on [buluma/reddie](https://github.com/buluma/reddie) (3 days ago)
- [Show ticket ID badge before status in issue modal](https://github.com/buluma/reddie/pull/17) on [buluma/reddie](https://github.com/buluma/reddie) (3 days ago)
- [Fix modal readability under window transparency](https://github.com/buluma/reddie/pull/16) on [buluma/reddie](https://github.com/buluma/reddie) (3 days ago)
- [Add target version dropdown, document is_private permission gap](https://github.com/buluma/reddie/pull/15) on [buluma/reddie](https://github.com/buluma/reddie) (4 days ago)
- [Render relations &#43; full changelog, add tracker/category editing](https://github.com/buluma/reddie/pull/14) on [buluma/reddie](https://github.com/buluma/reddie) (4 days ago)
- [Add macOS window transparency toggle (native vibrancy)](https://github.com/buluma/reddie/pull/13) on [buluma/reddie](https://github.com/buluma/reddie) (4 days ago)

#### 🔭 Latest releases I've contributed to

- [rmyndharis/OpenWA](https://github.com/rmyndharis/OpenWA) ([v0.10.0](https://github.com/rmyndharis/OpenWA/releases/tag/v0.10.0), today) - Free, Open Source, Self-Hosted WhatsApp API Gateway
- [buluma/reddie](https://github.com/buluma/reddie) ([v1.6.0](https://github.com/buluma/reddie/releases/tag/v1.6.0), 3 days ago) - A desktop Kanban board for Redmine. No server, no backend — just Redmine plus this app.
- [buluma/Redmine-desktop](https://github.com/buluma/Redmine-desktop) ([v2.4.4](https://github.com/buluma/Redmine-desktop/releases/tag/v2.4.4), 4 days ago) - A powerful, high-performance, and beautiful cross-platform Redmine client built with Electron, React, and Vite.
...
- [muety/wakapi](https://github.com/muety/wakapi) - 📊 A minimalist, self-hosted WakaTime-compatible backend for coding statistics (4 weeks ago)
