...
- [buluma/ansible-role-proxychains](https://github.com/buluma/ansible-role-proxychains) - Install Proxychains forcing TCP connection to follow through proxy like TOR or any other SOCKS4, SOCKS5 or HTTP(S) proxy. (today)
...
- [buluma/ansible-role-facts](https://github.com/buluma/ansible-role-facts) - Place custom facts for Ansible on a system. (2 weeks ago)
...
- [buluma/ansible-role-proxychains](https://github.com/buluma/ansible-role-proxychains) ([0.1.2](https://github.com/buluma/ansible-role-proxychains/releases/tag/0.1.2), today) - Install Proxychains forcing TCP connection to follow through proxy like TOR or any other SOCKS4, SOCKS5 or HTTP(S) proxy.
- [buluma/ansible-role-keepalived](https://github.com/buluma/ansible-role-keepalived) ([0.1.2](https://github.com/buluma/ansible-role-keepalived/releases/tag/0.1.2), 1 day ago) - Install and configure Keepalived on your Debian-like systems.
- [buluma/ansible-role-aliases](https://github.com/buluma/ansible-role-aliases) ([0.1.1](https://github.com/buluma/ansible-role-aliases/releases/tag/0.1.1), 1 week ago) - An ansible role for managing mail aliases.
